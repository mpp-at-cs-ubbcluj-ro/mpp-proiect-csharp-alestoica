...
namespace csharp_project_new.repository
{
    public class AgeEventDbRepository : IAgeEventRepository
    {
        ...
        public IEnumerable<AgeEvent> FindByAgeGroupAndSportsEvent(string ageGroup, string sportsEvent)
        {
            ...
            {
                comm.CommandText = "select * from age_events where age_group = @age_group and sports_event = @sports_event";
            ...
            log.InfoFormat("exiting FindByAgeGroupAndSportsEvent");
            return ageEvents;
        }
